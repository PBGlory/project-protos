...
type Task struct {
	...
	UserId        uint32                 `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // добавляем связь с пользователем
...
// Запросы и ответы для CRUD
type CreateTaskRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Title         string                 `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	UserId        uint32                 `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // нужно при создании задачи
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_task_task_proto_rawDesc = "" +
	"\n" +
	"\x15proto/task/task.proto\x12\x04task\"E\n" +
	"\x04Task\x12\x0e\n" +
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	10, // 15: task.TaskService.ListTasksByUser:output_type -> task.ListTasksByUserResponse
